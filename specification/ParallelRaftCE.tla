...
Entries == [term : Term \cup {-1}, date : Term \cup {-1}, value : Value \cup {Nil} , committed : {TRUE,FALSE}]
...
TypeSafety == /\ allLogs \in SUBSET (SUBSET allEntries)
              ...
              /\ endPoint \in [Server -> [Term -> ((Term \cup {-1}) \times (Index \cup {-1}))]]
              ...
              /\ halfElections \subseteq [eterm : Nat, eleaderCandidate : Server, esync : Nat,
                                         evotes : Quorums, elog : [Index -> Entries]]
              /\ elections \subseteq [eterm : Term, esync : Term, eleader : Server, evotes : Quorums, evoterLog : SUBSET [Index -> Entries],elog : [Index -> Entries]]
...
\* Last modified Wed Sep 09 15:26:50 CST 2020 by 15150

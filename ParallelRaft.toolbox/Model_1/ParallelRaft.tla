...
vars == <<r1amsgs,r1bmsgs,r2amsgs,r2bmsgs,r3amsgs,negMsgs,log,
            currentTerm,currentState,leaderLog,vote>>
...
Min(s) == CHOOSE i \in s : \A j \in s : j \geq i
...
BecomeLeaderCandidate(i) ==
    ...
    /\ \E Q \in Quorums :
        ...
        /\ leaderLog' = [leaderLog EXCEPT ![currentTerm[i]] =  [n \in Index |-> IF n \in 0..end THEN
                    Merge({l[2] : l \in {t \in allLog : t[1] = n}},currentTerm[i]) ELSE <<-1,Nil,FALSE>>]]
...
\* Last modified Fri Jun 26 16:48:00 CST 2020 by 15150
\* Last modified Tue Apr 21 22:27:18 CST 2020 by assstriker
